...
class _BuyahomeState extends State<Planatrip> {
  @override
  int selected = 0;
  int isRtl = 0;
  int rememberme = 0;
            ...
            children: <Widget>[
              ...
              InkWell(
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.pushNamed(context, 'PackingTemplate');
                  },
                ),
              ),
              InkWell(
              ...
              InkWell(
                ...
                onTap: () {
                  Navigator.pushNamed(context, 'Localweather');
                },
              ),
              InkWell(
                child: ListTile(
              ...
              InkWell(
                ...
                onTap: () {
                  Navigator.pushNamed(context, 'photoooth');
                },
              ),
            ],
          ),
